-- =====================================================================
-- SCRIPT DE BANCO DE DADOS - PLATAFORMA INTELBRASTECH (MÓDULO ALFA)
-- COMPATÍVEL COM MYSQL 8+ E ESTRUTURA POLIMÓRFICA + SPATIE
-- =====================================================================
...
-- ---------------------------------------------------------------------
-- 1. TABELA: users (Autenticação Centralizada e Núcleo Polimórfico)
-- ---------------------------------------------------------------------
CREATE TABLE `users` (
  ...
  `role` ENUM('master', 'regional', 'technician', 'company', 'client') NOT NULL DEFAULT 'client',
  `google_id` VARCHAR(255) DEFAULT NULL,
  `microsoft_id` VARCHAR(255) DEFAULT NULL,
  `is_active` TINYINT(1) NOT NULL DEFAULT 0,
  `remember_token` VARCHAR(100) DEFAULT NULL,
  `fcm_token` TEXT DEFAULT NULL,
  `profileable_id` BIGINT UNSIGNED DEFAULT NULL,   -- ID do Perfil Vinculado (Polimorfismo)
  `profileable_type` VARCHAR(255) DEFAULT NULL,    -- Classe do Perfil Vinculado (Polimorfismo)
  ...
  KEY `users_profileable_index` (`profileable_id`, `profileable_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ---------------------------------------------------------------------
-- 2. TABELA: technicians (Perfil do Profissional Autônomo - Expandido)
-- ---------------------------------------------------------------------
CREATE TABLE `technicians` (
  ...
  `banner_url` VARCHAR(255) DEFAULT NULL,          -- Adicionado pela Auditoria
  `resume_url` VARCHAR(255) DEFAULT NULL,          -- Adicionado pela Auditoria
  `bio` TEXT DEFAULT NULL,
  `experience_years` INT UNSIGNED DEFAULT 0,       -- Adicionado pela Auditoria
  `is_remote` TINYINT(1) NOT NULL DEFAULT 1,       -- Adicionado pela Auditoria
  `cep` VARCHAR(9) NOT NULL,
  `state` CHAR(2) NOT NULL,
  `city` VARCHAR(255) NOT NULL,
  `neighborhood` VARCHAR(255) NOT NULL,
  `location` POINT NOT NULL SRID 4326,             -- Geometria GPS WGS84
  ...
  SPATIAL INDEX `technicians_location_spatial` (`location`),
  KEY `technicians_regional_index` (`state`, `city`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ---------------------------------------------------------------------
-- 3. TABELA: companies (Perfil Corporativo - Integrador / Distribuidor)
-- ---------------------------------------------------------------------
CREATE TABLE `companies` (
  ...
  `ie` VARCHAR(50) DEFAULT NULL,                   -- Inscrição Estadual
  `phone` VARCHAR(20) NOT NULL,
  `whatsapp` VARCHAR(20) NOT NULL,
...
-- ---------------------------------------------------------------------
-- 4. TABELA: categories (Especialidades Atendidas)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 5. TABELA PIVÔ: category_technician (Relacionamento N:M Especialidades)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 6. TABELA: tickets (Ordens de OS vinculadas ao Usuário Central)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 7. TABELA: reports_rat (Relatório de Atendimento Técnico)
-- ---------------------------------------------------------------------
CREATE TABLE `reports_rat` (
  ...
  `client_signature` LONGTEXT NOT NULL, 
...
-- ---------------------------------------------------------------------
-- 8. TABELA: posts (Rede Social Técnica - Publicações)
-- ---------------------------------------------------------------------
CREATE TABLE `posts` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT,
...
-- ---------------------------------------------------------------------
-- 9. TABELA: comments (Rede Social Técnica - Comentários)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 10. TABELA: likes (Rede Social Técnica - Curtidas Únicas)
-- ---------------------------------------------------------------------
CREATE TABLE `likes` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT,
  `post_id` BIGINT UNSIGNED NOT NULL,
...
-- ---------------------------------------------------------------------
-- 11. TABELA: meetings (Videoconferências Remotas via Meet / Teams)
-- ---------------------------------------------------------------------
